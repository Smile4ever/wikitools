...
1. It takes a while to fetch the page. Running the script again when it is not finished will not get you the desired results.
2. To prevent unnecessary load on the MediaWiki API of the site you are using.
